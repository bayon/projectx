...
//---SQL INSERT -------------------------------
	...
	function create($admin,$return = "json") {
		...
		VALUES('".$admin->get_id()."' , '".$admin->get_name()."' , '".$admin->get_app_id()."' , '".$admin->get_username()."' , '".$admin->get_password()."' , '".$admin->get_settings_id()."' , '".$admin->get_acct_id()."' , '".$admin->get_dt_created()."' , '".$admin->get_dt_modified()."' , '".$admin->get_parent_id()."' );"; 
	$data = $this -> exe_sql($con,$sql, $return);
	 ...
	 function update($admin,$return = "json") {
		$con = $this -> model_connect();
		$sql = "UPDATE ".$this -> getDatabase().".admin set id = '".$admin->get_id()."' , name = '".$admin->get_name()."' , app_id = '".$admin->get_app_id()."' , username = '".$admin->get_username()."' , password = '".$admin->get_password()."' , settings_id = '".$admin->get_settings_id()."' , acct_id = '".$admin->get_acct_id()."' , dt_created = '".$admin->get_dt_created()."' , dt_modified = '".$admin->get_dt_modified()."' , parent_id = '".$admin->get_parent_id()."'  WHERE id = ".$admin->get_id()."";	
		$data = $this -> exe_sql($con, $sql, $return);
 		echo($data);
	}
