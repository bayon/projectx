<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////
 var controller = 'canalope_controller'; 
 var TABLE_DATA = []; 
...
*/  
  ?>  
<!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-canalope' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 	<div class='modal-dialog'>
 		<div class='modal-content'>
 			<div class='modal-header'>
 				...
 				<h4 class='modal-title' id='myModalLabel'> canalope </h4>
 			</div>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
 	<div class='row top-row'>
 		<div class='col-md-12'>
 			<div id='stage'>
 				<div class='tablelite-title-row'><h3>canalope<button class='create_btn' >+</button> 					<a id='modal-canalope' style='' href='#modal-container-canalope' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 ...
 function load_data(){
 	var dataString = "c=canalope_controller&m=readToJSON&data_only=true";
 ...
 function rowClick(i) {
 	document.getElementById('modal-canalope').click();
		...
		footer +="<button type='button' class='btn btn-default' data-dismiss='modal' onclick='delete_canalope( "  +TABLE_DATA[i]['id']+");'  >delete</button>"; 
 ...
 function rowClick_drillDown(i){
 	    ...
 	    html += "<div class='panel_field'><button  onclick='delete_canalope( "+TABLE_DATA[i]['id']+");' class='panel_btn btn_delete'>Delete</button></div>";
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
  ...
  */  
 	...
 	var dataString = 'c=canalope_controller&m=create&data_only=true&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=canalope_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=canalope_controller&m=edit&'+params;
 ...
 function delete_canalope(id){
 		if(confirm('Are you sure you want to delete this canalope?'))
 		{ verify_delete(id); } else {  deny(); }
 }
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=canalope_controller&m=delete&id=' + data.id  ;
