<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////
 var controller = 'monkey_controller'; 
 var TABLE_DATA = []; 
...
*/  
  ?>  
<!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-monkey' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 	<div class='modal-dialog'>
 		<div class='modal-content'>
 			<div class='modal-header'>
 				...
 				<h4 class='modal-title' id='myModalLabel'> monkey </h4>
 			</div>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
 	<div class='row top-row'>
 		<div class='col-md-12'>
 			<div id='stage'>
 				<div class='tablelite-title-row'><h3>monkey<button class='create_btn' >+</button> 					<a id='modal-monkey' style='' href='#modal-container-monkey' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 ...
 function load_data(){
 	var dataString = "c=monkey_controller&m=readToJSON&data_only=true";
 ...
 function rowClick(i) {
 	document.getElementById('modal-monkey').click();
		...
		footer +="<button type='button' class='btn btn-default' data-dismiss='modal' onclick='delete_monkey( "  +TABLE_DATA[i]['id']+");'  >delete</button>"; 
 ...
 function rowClick_drillDown(i){
 	    ...
 	    html += "<div class='panel_field'><button  onclick='delete_monkey( "+TABLE_DATA[i]['id']+");' class='panel_btn btn_delete'>Delete</button></div>";
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
  ...
  */  
 	...
 	var dataString = 'c=monkey_controller&m=create&data_only=true&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=monkey_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=monkey_controller&m=edit&'+params;
 ...
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=monkey_controller&m=delete&id=' + data.id  ;
