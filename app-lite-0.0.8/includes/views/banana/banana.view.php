<script> 
 // PARAMETERS ///////////////////////////////////////////////////////////////////////////
 var controller = 'banana_controller'; 
 var TABLE_DATA = []; 
...
*/  
  ?>  
<!--  THE MODAL -->
 <div style='margin-top:5%;' class='modal fade' id='modal-container-banana' role='dialog' aria-labelledby='myModalLabel' aria-hidden='false'>
 	<div class='modal-dialog'>
 		<div class='modal-content'>
 			<div class='modal-header'>
 				...
 				<h4 class='modal-title' id='myModalLabel'> banana </h4>
 			</div>
 ...
 <div id='template_view_1' class='container animated fadeIn kioview' style='text-align:center;'  >
 	<div class='row top-row'>
 		<div class='col-md-12'>
 			<div id='stage'>
 				<div class='tablelite-title-row'><h3>banana<button class='create_btn' >+</button> 					<a id='modal-banana' style='' href='#modal-container-banana' role='button' class='btn invisible' data-toggle='modal'>modal-1</a>
 ...
 function load_data(){
 	var dataString = "c=banana_controller&m=readToJSON&data_only=true";
 ...
 function rowClick(i) {
 	document.getElementById('modal-banana').click();
		...
		footer +="<button type='button' class='btn btn-default' data-dismiss='modal' onclick='delete_banana( "  +TABLE_DATA[i]['id']+");'  >delete</button>"; 
 ...
 function rowClick_drillDown(i){
 	    ...
 	    html += "<div class='panel_field'><button  onclick='delete_banana( "+TABLE_DATA[i]['id']+");' class='panel_btn btn_delete'>Delete</button></div>";
...
//  DATA CREATE   /////////////////////////////////////////////////////////////////////////////////         
  ...
  */  
 	...
 	var dataString = 'c=banana_controller&m=create&data_only=true&'+params;
 ...
 function create_callback(data){
 	//alert(data);
 	 $(location).attr('href',JS_CONFIG.BASE_URL+'?c=banana_controller&m=read');
 }
 //  DATA EDITING   /////////////////////////////////////////////////////////////////////////////////         
 function save_edit(id) {
	...
	break;				default:
 	...
 	var params = $.param(data);
 	var dataString = 'c=banana_controller&m=edit&'+params;
 ...
 function delete_banana(id){
 		if(confirm('Are you sure you want to delete this banana?'))
 		{ verify_delete(id); } else {  deny(); }
 }
 function verify_delete(id) {
 	var data = {};
 	data.id = id;
 	var dataString = 'c=banana_controller&m=delete&id=' + data.id  ;
